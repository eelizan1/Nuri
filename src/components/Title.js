...
const ContentBounceIn = styled(MainTitle)`
  ...
  margin-top: 30px;
`
const InputBounceIn = styled(MainTitle)`
  animation-name: ${bounceInUpAnimation};
  animation-delay: 2.5s;
  font-size: 16px;
  margin-top: 30px;
...
const Heading = ({ heading, subheading, content, input }) =>
  <div>
    ...
    <InputBounceIn>{input}</InputBounceIn>
  </div>
;
...
const Title = () => (
  <Wrapper>
    <Heading heading="We are coming soon!" subheading="Introducing Nuri" content="Be able to share and find homemade foods around you within your own neighborhood! Sign-up today to be our first users and get the latest updates." input={<Input/>}/>
